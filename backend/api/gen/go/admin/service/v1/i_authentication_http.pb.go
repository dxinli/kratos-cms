...
const OperationAuthenticationServiceRegister = "/admin.service.v1.AuthenticationService/Register"
...
func RegisterAuthenticationServiceHTTPServer(s *http.Server, srv AuthenticationServiceHTTPServer) {
	...
	r.POST("/admin/v1/register", _AuthenticationService_Register0_HTTP_Handler(srv))
}
...
func (c *AuthenticationServiceHTTPClientImpl) Register(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	var out emptypb.Empty

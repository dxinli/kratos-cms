...
func file_content_service_v1_post_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_content_service_v1_post_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
		...
		file_content_service_v1_post_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_content_service_v1_post_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_content_service_v1_post_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_content_service_v1_post_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_content_service_v1_post_proto_msgTypes[5].Exporter = func(v any, i int) any {
